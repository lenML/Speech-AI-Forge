...
class CosyVoiceFrontEnd:
    ...
    def frontend_sft(self, tts_text, spk_embedding):
    ...
    def frontend_instruct(self, tts_text, spk_embedding, instruct_text):
        model_input = self.frontend_sft(tts_text, spk_embedding)
