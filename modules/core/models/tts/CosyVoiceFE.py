...
import re
import inflect
from modules.repos_static.cosyvoice.cosyvoice.utils.file_utils import logging, load_wav
    ...
    def __init__(
        ...
        if os.path.exists(spk2info):
            self.spk2info = torch.load(
                spk2info, map_location=self.device, weights_only=True
            )
        else:
            self.spk2info = {}
