...
class AudioReshaper:
    ...
    @staticmethod
    def resample_audio(audio: NP_AUDIO, target_sr: int):
        sr, data = audio
    ...
    @staticmethod
    def ensure_float32(audio: NP_AUDIO):
        sr, data = audio
    ...
    @staticmethod
    def ensure_stereo_to_mono(audio: NP_AUDIO):
        sr, data = audio
        if data.ndim == 2:
    ...
    @staticmethod
    def normalize_audio(audio: NP_AUDIO, target_sr: int):
